...
'INSTANT VB NOTE: The variable close was renamed since Visual Basic does not handle local variables named the same as class members well:
		Public Sub New(ByVal arg As DateTime, ByVal low_Conflict As Double, ByVal high_Conflict As Double, ByVal open_Conflict As Double, ByVal close_Conflict As Double)
			Me.Argument = arg
			Me.Low = low_Conflict
